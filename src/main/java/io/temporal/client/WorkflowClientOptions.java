...
import io.temporal.common.converter.JacksonJsonDataConverter;
...
public final class WorkflowClientOptions {
  ...
  public static final class Builder {
     ...
     * results.
     *
     * <p>Default is {@link JacksonJsonDataConverter} data converter.
     */
    ...
    public WorkflowClientOptions validateAndBuildWithDefaults() {
      ...
      return new WorkflowClientOptions(
          ...
          dataConverter == null ? JacksonJsonDataConverter.getInstance() : dataConverter,
